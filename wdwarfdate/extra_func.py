...
def calc_percentiles(ln_ms_age, ln_cooling_age, ln_total_age, initial_mass,
    ...
    cooling_age_err_low = cooling_age_median - np.nanpercentile(ln_cooling_age,
                                                                low_perc)
    ...
    total_age_err_low = total_age_median - np.nanpercentile(ln_total_age,
                                                            low_perc)
    ...
    initial_mass_err_low = initial_mass_median - np.nanpercentile(initial_mass,
                                                                  low_perc)
    initial_mass_err_high = np.nanpercentile(initial_mass,
                                             high_perc) - initial_mass_median
