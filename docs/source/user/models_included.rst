...
|                 |                  |  - Thick H layer: :math:`2,500 \lesssim T_{\rm eff} \lesssim 100,000` K, :math:`7.0 \lesssim \log g \lesssim 9.0`                                                                                      |
|                 |                  |  - Thin H layer: :math:`3,250 \lesssim T_{\rm eff} \lesssim 100,000` K, :math:`7.0 \lesssim \log g \lesssim 9.0`                                                                                       |
|                 +------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
